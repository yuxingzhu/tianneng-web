        ...
        series: [
          {
            name: '装配电池',
            type: 'bar',
            data: chartData.monthlySalesVolume.assemblingBatteries,
            itemStyle: {
              normal: {
                color: '#00FFF9',
                label: {
          ...
          },
          {
            name: '极板销量',
            type: 'bar',
            data: chartData.monthlySalesVolume.extremeEditionSales,
            itemStyle: {
              normal: {
                color: '#975BFF',
                label: {
          ...
          },
          {
            name: '电池销量',
            type: 'bar',
            data: chartData.monthlySalesVolume.batterySales,
            itemStyle: {
              normal: {
                color: '#F4FF4F',
                label: {
